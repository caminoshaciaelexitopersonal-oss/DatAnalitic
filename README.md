...
-   **Frontend:** Una aplicación web construida con **Next.js**, **React** y **TypeScript**. Utiliza **Tailwind CSS** para el estilo y **Recharts** para las visualizaciones de datos.
